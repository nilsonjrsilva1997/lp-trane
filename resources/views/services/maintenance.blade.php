                ...
                <form>
                    <div class="container mt-5">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12"> <div style="position:relative;" class="p-1">
                                        <a class='btn btn-primary' href='javascript:;'>
                                            Escolher arquivo
                                            <input type="file" class="input-file" name="file_source" size="40"  
                                            onchange='$("#upload-file-info").html($(this).val());'>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="" id="" cols="60" rows="5" class="form-control" placeholder="Descreva o local de manutenção"></textarea>
                                </div>
                            </div>                                    
                        </div>
